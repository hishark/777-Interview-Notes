...
MySQL 中提供了两种封锁粒度：[行级锁以及表级锁](https://blog.csdn.net/qq\_35246620/article/details/69943011)。
...
MVCC 维护了一个 ReadView 结构，主要包含了当前系统未提交的事务列表 TRX_IDs {TRX_ID\_1, TRX_ID\_2, ...}，还有该列表的最小值 TRX_ID_MIN 和 TRX_ID_MAX。
